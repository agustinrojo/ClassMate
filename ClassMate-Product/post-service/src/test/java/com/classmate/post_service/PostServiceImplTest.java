...
//        List<PostResponseDTO> commentDTOS = Arrays.asList(
//                new PostResponseDTO(1L, postId, 1L, "Comment 1", null),
//                new PostResponseDTO(2L, postId, 1L, "Comment 2", null)
//        );
//
//        when(postRepository.findById(postId)).thenReturn(Optional.of(post));
//        when(postMapper.convertToPostResponseDTO(post)).thenReturn(apiResponseDTO);
